      ...
      <div className="relative h-screen overflow-hidden w-full">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center text-white h-full px-4">
          ...
          <p className="text-lg mb-4">
            Hemos recibido tu solicitud de reserva y actualmente está en proceso
            de revisión.
          </p>
          <p className="text-lg mb-4">
            Recibirás un correo electrónico tan pronto como confirmemos tu
            reserva. En ese momento, te proporcionaremos los detalles para
            realizar el abono del pago.
          </p>
          <p className="text-xl font-semibold">
            ¡Gracias por confiar en Zorro Azul!
          </p>
          <button
            className="mt-5 px-4 py-2 bg-lime-500 text-white rounded hover:bg-lime-600"
