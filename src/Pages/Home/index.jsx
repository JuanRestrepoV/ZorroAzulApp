        ...
        <div className="relative z-20 flex justify-between items-center h-full px-16 text-white">
          ...
          <div className="flex-1 flex flex-col justify-center items-start text-left">
            ...
            <div className="text-gray-300 space-y-6 text-lg leading-4 mb-6 font-Fuente text-justify max-w-[90%]">
              <p>
                En Zorro Azul, cada evento corporativo es una experiencia
                diseñada a medida.
              </p>
              <p>
                Nuestro rooftop, en el corazón de Cali, se convierte en el
                escenario perfecto para que su equipo se conecte, celebre y
                descubra nuevas perspectivas en un espacio exclusivo y
                auténtico.
              </p>
              <p>
                Permítanos personalizar cada detalle de su evento para que sea
